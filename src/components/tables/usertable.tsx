  ...
  React.useEffect(() => {
    ...
    if (accessToken) {
      axios
        ...
        .catch((error) => {
          console.error("El perfil ejecutor no tiene acceso a la lista de usuarios");
        });
    }
  }, []);
              ...
              {rows.map((row, index) => {
                ...
                return (
                  ...
                  >
                    ...
                    <TableCell>{row.role === "ADMINISTRATOR" ? "Administrador" : "Ejecutor" }</TableCell>
                  </TableRow>
                );
              })}
              {emptyRows > 0 && (
